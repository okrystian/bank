...
namespace Bank
{
    class BankManager
    {
            ...
            do
            {
                ...
                switch (action)
                {
                    ...
                    case 8:
                        ...
                        break;
                    default:
                        Console.Write("Nienane polecenie ");
                        break;
                }
            }
            while (action != 0);
        ...
        private void ListOfAccounts()
        {
            ...
            foreach (Account account in _accountsManager.GetAllAcountsFor(data.FirstName, data.LastName, data.Pesel))
            {
        ...
        private void TakeMoney()
        {
            ...
            Console.WriteLine("Pobranie pieniędzy");
            Console.Write("Numer konta: ");
            accountNo = Console.ReadLine();
            Console.Write("Kwota: ");
            value = decimal.Parse(Console.ReadLine());
